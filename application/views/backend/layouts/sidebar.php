    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <?php if ($userdataTipe == 99) : ?>
        ...
        <li class="treeview <?php if ($this->uri->segment(1) == 'kelas' || $this->uri->segment(1) == 'mapel') {
          ...
          <a href="#">
            <i class="glyphicon glyphicon-blackboard"></i> <span>Data Master</span>
      ...
      <?php if ($userdataTipe == 88) : ?>
        ...
        <li class="<?php if ($this->uri->segment(2) == 'pesan' || $this->uri->segment(3) == 'add-pesan') {
                      echo 'active';
                    } ?>">
          <a href="<?= site_url('gr/pesan'); ?>">
            <i class="fa fa-users"></i> <span>Kirim SMS</span>
          </a>
        </li>
      <?php endif; ?>
    </ul>
